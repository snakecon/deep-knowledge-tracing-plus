...
parser.add_argument("-kp", "--keep_prob", type=float, default=0.333,
...
parser.add_argument("-lw1", "--lambda_w1", type=float, default=0.003,
                    help="The lambda coefficient for the regularization waviness with l1-norm.")
parser.add_argument("-lw2", "--lambda_w2", type=float, default=3.0,
                    help="The lambda coefficient for the regularization waviness with l2-norm.")
parser.add_argument("-lo", "--lambda_o", type=float, default=0.1,
